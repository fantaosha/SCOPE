...
PinholeCameraFactor::PinholeCameraFactor(
    const std::vector<int> &poses, const std::vector<int> &shapes,
...
int PinholeCameraFactor::preLinearizeRobustKernel(const Evaluation &eval,
