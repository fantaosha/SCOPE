...
namespace scope {
FullJointPinholeCameraFactor::FullJointPinholeCameraFactor(
...
int FullJointPinholeCameraFactor::evaluate(
...
int FullJointPinholeCameraFactor::linearize(
    const AlignedVector<Pose> &poses, const AlignedVector<VectorX> &shapes,
    const AlignedVector<Matrix3> &joints, const AlignedVector<VectorX> &params,
...
int FullJointPinholeCameraFactor::evaluate(const Pose &pose,
  ...
  JointPinholeCameraFactor::evaluate(pose, eval.camMeasurement, eval);

  return 0;
}

int FullJointPinholeCameraFactor::linearize(const Pose &pose,
                                            const VectorX &camParam,
                                            const Vector2 &measurement,
  ...
  JointPinholeCameraFactor::linearize(pose, eval.camMeasurement, eval, lin);
