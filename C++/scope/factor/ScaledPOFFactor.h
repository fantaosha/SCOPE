...
namespace scope {
class ScaledPOFFactor : public POFFactor {
 public:
 ...
 public:
  ...
  ScaledPOFFactor(int pose, int vParam, const std::array<Matrix3X, 2> &VDirs,
 ...
 protected:
  ...
  virtual int linearize(const Pose &pos, const VectorX &vertexParam,
