...
namespace scope {
class FullJointExtraPinholeCameraFactor : public JointExtraPinholeCameraFactor {
public:
  struct Evaluation : public JointExtraPinholeCameraFactor::Evaluation {
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW

    Vector2 camMeasurement;
  };

  struct Linearization : public JointExtraPinholeCameraFactor::Linearization {
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
...
public:
  ...
  FullJointExtraPinholeCameraFactor(int pose, int camParam, const Scalar &sigma,
